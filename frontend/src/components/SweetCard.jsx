  ...
  return (
    <Link to={`/sweet/${sweet.id}`} className="block">
      <motion.div 
        ...
        whileHover="hover"
        custom={index}
        style={{ minHeight: 420, maxHeight: 440 }}
      >
        {/* Glow effect */}
        <motion.div 
        ...
        {/* Main card */}
        <div className="relative bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl overflow-hidden h-full flex flex-col min-h-[420px] max-h-[440px]">
          {/* Background pattern */}
          ...
          {/* Sweet name */}
          <motion.h3 
            className="text-xl font-bold text-white mb-4 text-center relative z-10 min-h-[2.5rem] flex items-center justify-center"
          ...
          <div className="flex-grow flex flex-col justify-between relative z-10">
            {/* Price section */}
            <motion.div 
              className="text-center mb-6 min-h-[3.5rem] flex flex-col justify-center"
